...
r_template <- rast(ext, res=2) #TODO; Check resolution

r1_r = resample(r1, r_template, method = "average")
writeRaster(r1_r,file.path("F:/Big Data/DTM_Scotland_Phase1_2M.tif"),
            filetype = "GTiff", gdal = c("COMPRESS=DEFLATE","PREDICTOR=3","ZLEVEL=9","BIGTIFF=YES"))


# gg <- lapply(list(r1, r2), function(i) resample(i, crop(r_template, i, "out"), method = "average"))
#
#
#
#
